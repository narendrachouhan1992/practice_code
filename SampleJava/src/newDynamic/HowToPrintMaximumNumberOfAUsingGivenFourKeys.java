...
public class HowToPrintMaximumNumberOfAUsingGivenFourKeys {
	...
	public static void main(String[] args) {
		HowToPrintMaximumNumberOfAUsingGivenFourKeys obj = new HowToPrintMaximumNumberOfAUsingGivenFourKeys();
		System.out.println(obj.findoptimal(20));
	}
}
