...
public class DynamicProgrammingSet37BooleanParenthesizationProblem {
	...
	public static void main(String[] args) {
		DynamicProgrammingSet37BooleanParenthesizationProblem obj = new DynamicProgrammingSet37BooleanParenthesizationProblem();
		char symbols[] = "TTFT".toCharArray();
	    char operators[] = "|&^".toCharArray();
	    System.out.println(obj.countParenth(symbols, operators, symbols.length));
