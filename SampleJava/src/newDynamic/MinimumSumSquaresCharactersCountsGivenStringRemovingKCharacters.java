...
public class MinimumSumSquaresCharactersCountsGivenStringRemovingKCharacters {
	final static  int MAX_CHAR = 256;
	 ...
	 public static void main(String[] args) {
		MinimumSumSquaresCharactersCountsGivenStringRemovingKCharacters obj = new MinimumSumSquaresCharactersCountsGivenStringRemovingKCharacters();
		String str = "abbccc"; 
		obj.minStringValue(str, 2);
		str = "aaab"; 
		obj.minStringValue(str, 2);
	}
}
